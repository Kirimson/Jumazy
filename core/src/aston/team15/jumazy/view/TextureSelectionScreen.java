...
public class TextureSelectionScreen extends MenuScreen {
	...
	public TextureSelectionScreen(JumazyController theGame) {
		...
		MenuScreenButton texture1 = new MenuScreenButton("Current", null, game);
		MenuScreenButton texture2 = new MenuScreenButton("Old English", null, game);
		MenuScreenButton texture3 = new MenuScreenButton("Snow", null, game);
